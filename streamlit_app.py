...
if check_password():
    ...
    def streamlit_app():
        ...
        excel_file = st.file_uploader("Upload or select an Excel file to append data to", type='xlsx')
            ...
            if uploaded_files is not None:
                ...
                if all_data:
                    ...
                    if st.button("Is the data correct? Click to append to Excel."):
                        # Use the in-memory Excel file directly
                        excel_file_path = excel_file.name  # Use the original file name
